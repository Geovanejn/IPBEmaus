...
import { registerPublicLgpdRoutes } from "./routes/lgpd-public";
...
export async function registerRoutes(app: Express): Promise<Server> {
  ...
  // NOTA: As rotas públicas LGPD para membros/visitantes estão em server/routes/lgpd-public.ts
  // Estas rotas abaixo são apenas para administração interna (funcionários)
